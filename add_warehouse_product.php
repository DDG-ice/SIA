         ...
         <div class="col-md-12">
          <form method="post" action="add_warehouse_product.php" class="clearfix">
              ...
              <i class="glyphicon glyphicon-barcode"></i>
                ...
                <div class="row">
                  <div class="col-md-6">
                   <input type="text" class="form-control" id="barcodeInput" name="barcodeInput" placeholder="Generated Barcode" value="<?php echo isset($_POST['generate']) ? barcode_generator() : ''; ?>">           
                  </div>
                  <button type="submit" class="btn btn-warning" name="generate">Generate Barcode</button>
                </div>
              </div>             
              <br>
              <div class="form-group">
  ...
  <div class="col-md-8">
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            <span class="glyphicon glyphicon-th"></span>
            <span>Add New Warehouse Product Via Scanner</span>
         </strong>
        </div>
        <div class="panel-body">
          <div class="col-md-12">
